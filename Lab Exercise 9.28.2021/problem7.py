##Lab Exercise 9/28/2021 Problem 7
##Author: 
...
#this function calculates your GPA given the letterGrades list and the
#number of classes
...
def printReportCard(classes, scores, letterGrades, GPA, numClasses):
    ...
    for i in range(numClasses):
        print (classes[i] + ' - ' + str(scores[i]) + '(' + letterGrades[i] + ')')
    print ("Overall GPA = " + str(round(gpa,2)))
...
#get the number of classes you are taking and store in numClasses
#Add code here
...
calcLetterGrade(scores)

#Calculate GPA
gpa = calcGPA(letterGrades, numClasses)
