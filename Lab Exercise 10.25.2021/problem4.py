## Lab Exercise 10/25/2021 Problem 4
## Author: 
...
#get monetary amount from user and store in variable amount
#Add code here
...
#break apart dollars digit by digit and store in thousands, hundreds,
#tens, and ones
#Add code here


#break apart cents digit by digit and store in dimes nad pennies
#Add code here
...
print (d4 + d3 + d2 + d1 + 'dollars and ' + c2 + c1 + 'cents')
